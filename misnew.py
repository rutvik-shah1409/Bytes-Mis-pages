            ...
            with self.subTest(country=country_name, page=page_type):
                try:
                    ...
                    if page_type in ["Book Free Consultation", "Contact Us"]:
                        ...
                        self.close_service_popup_if_present(timeout=15)
                        time.sleep(5)
...
#     # Popup close button
#     POPUP_CLOSE_BUTTON = (By.XPATH, "/html/body/div[17]/button")
...
#                             EC.element_to_be_clickable(ElementLocators.POPUP_CLOSE_BUTTON.value)
#                             )
#                             close_btn.click()
#                             time.sleep(1)
#                             print("Popup closed successfully.")
